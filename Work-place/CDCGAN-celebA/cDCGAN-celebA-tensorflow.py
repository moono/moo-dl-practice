...
def generator(z, y, out_dim, reuse=False, initial_feature_size=512, alpha=0.2, is_training=True):
    ...
    with tf.variable_scope('generator', reuse=reuse):
        ...
        # 1. Fully connected layer (make 4x4x(512+2)) & reshape to prepare first layer
        ...
        # 2. deconvolutional layer (make 8x8x(256+2))
        ...
        # 3. deconvolutional layer (make 16x16x(128+2))
        feature_map_size = feature_map_size // 2
        ...
        # 4. deconvolutional layer (make 32x32x(64+2))
        feature_map_size = feature_map_size // 2
